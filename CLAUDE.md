...
1. 개발 환경: Linux 데스크탑, Vivado 네이티브, Python 3.13, uv 패키지 매니저
1. Python 실행: `.venv/bin/python` 또는 `uv run --no-sync python`
1. 시뮬레이션: iverilog (`-g2012`) + vvp
1. GitHub: young-0320/zynq-axi-fir-decimation-ip
1. Vivado 빌드 경로: `/mnt/workspace/10_zynq-fir-decimation-ip_build/`
