...
> 2026-07-21 초안. 슬라이드당 핵심 메시지 1개 + 사용할 그림/표 지정.
> `[TrackB]` = 수요일 실측 후 채움. 예상 12장 + 백업.
...
| 12 | 보조지표 ② 전력 실측 | [TrackB] S0/S1/S2 차분 표 + Vivado 1.705W 대비 해석 | [TrackB] 측정 표 |
...
| 질문 | 답 |
|---|---|
| 버그를 어떻게 찾고 고쳤나 | 슬라이드 7 + log 43 (읽을것.md 1번 항목) |
| Fmax 숫자 아직 유효한가 | 백업 B2 |
| ASIC에서 왜 v1=v2인가 / v2 만든 의미는 | 슬라이드 11 + 백업 B1 — "타겟 특화 최적화의 실증"으로 반전 |
| 전력이 추정과 왜 다른가 | [TrackB] on-chip 추정 vs 보드 5V 전체(DDR/레귤레이터 포함) 차이 |
