...
#
# 산출물 ($OUT_DIR = build/fir_n43_v1_freq_${CLKWIZ_FREQ_MHZ}mhz/output, docs/build_artifacts.md 참고):
...
#   예: vivado -mode batch -source vivado/fir_n43/build_bd_fir_dma_clkwiz.tcl -tclargs 115
#   (v1 fir_n43.v 기준 clk_wiz 재스윕. overlay/bd cell 이름은 v1/v2 공통이라 동일 overlay 재사용)
