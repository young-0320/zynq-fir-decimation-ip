...
################################################################
# This is a generated script based on design: bd_fir_dma_axis_debug
#
...
# source bd_fir_dma_axis_debug.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# axis_decimator_m2_n43_debug
...
set design_name bd_fir_dma_axis_debug
...
\
  ...
  # Create instance: axis_decimator_m2_n43_debug_0, and set properties
  set block_name axis_decimator_m2_n43_debug
  set block_cell_name axis_decimator_m2_n43_debug_0
  if { [catch {set axis_decimator_m2_n43_debug_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axis_decimator_m2_n43_debug_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins axis_decimator_m2_n43_debug_0/s_axis]
  ...
  connect_bd_intf_net -intf_net axis_decimator_m2_n43_debug_0_m_axis [get_bd_intf_pins axis_decimator_m2_n43_debug_0/m_axis] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  ...
  [get_bd_pins axis_decimator_m2_n43_debug_0/aclk]
  ...
  [get_bd_pins axis_decimator_m2_n43_debug_0/aresetn]
