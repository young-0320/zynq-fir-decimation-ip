...
################################################################
# This is a generated script based on design: bd_fir_dma
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: fir_decimator_n43_ax_0, and set properties
  set block_name fir_decimator_n43_axis
  set block_cell_name fir_decimator_n43_ax_0
  if { [catch {set fir_decimator_n43_ax_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $fir_decimator_n43_ax_0 eq "" } {
  ...
  [get_bd_pins fir_decimator_n43_ax_0/s_axis_tdata]
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tlast  [get_bd_pins axi_dma_0/m_axis_mm2s_tlast] \
  [get_bd_pins fir_decimator_n43_ax_0/s_axis_tlast]
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tvalid  [get_bd_pins axi_dma_0/m_axis_mm2s_tvalid] \
  [get_bd_pins fir_decimator_n43_ax_0/s_axis_tvalid]
  connect_bd_net -net axi_dma_0_s_axis_s2mm_tready  [get_bd_pins axi_dma_0/s_axis_s2mm_tready] \
  [get_bd_pins fir_decimator_n43_ax_0/m_axis_tready]
  connect_bd_net -net fir_decimator_n43_ax_0_m_axis_tdata  [get_bd_pins fir_decimator_n43_ax_0/m_axis_tdata] \
  [get_bd_pins axi_dma_0/s_axis_s2mm_tdata]
  connect_bd_net -net fir_decimator_n43_ax_0_m_axis_tlast  [get_bd_pins fir_decimator_n43_ax_0/m_axis_tlast] \
  [get_bd_pins axi_dma_0/s_axis_s2mm_tlast]
  connect_bd_net -net fir_decimator_n43_ax_0_m_axis_tvalid  [get_bd_pins fir_decimator_n43_ax_0/m_axis_tvalid] \
  [get_bd_pins axi_dma_0/s_axis_s2mm_tvalid]
  connect_bd_net -net fir_decimator_n43_ax_0_s_axis_tready  [get_bd_pins fir_decimator_n43_ax_0/s_axis_tready] \
